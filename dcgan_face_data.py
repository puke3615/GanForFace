...
from data_loader import load_face_data
...
class DCGAN_Expand():
    ...
    def build_generator(self):
        ...
        x = Conv2DTranspose(32, kernel_size=5, strides=1, padding="same", activation='relu')(x)
        x = BatchNormalization(momentum=0.8)(x)

        x = Conv2DTranspose(16, kernel_size=5, strides=1, padding="same", activation='relu')(x)
        x = BatchNormalization(momentum=0.8)(x)
    ...
    def train(self, epochs, batch_size=128, save_interval=50):
        ...
        generator = load_face_data(batch_size, self.img_rows, self.img_cols)
